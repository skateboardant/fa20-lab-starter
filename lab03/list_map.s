...
map:
    ...
    # By base address + offset
    # load the value of the current node into a0
    # THINK: why a0?
    ### YOUR CODE HERE ###       because we can pass argument through a0 to square
    lw a0, 0(s0)
    ...
    ### YOUR CODE HERE ###       because we need two arguments, a0 is for the address of the last node
    add a1, s1, x0
    # recurse
    ### YOUR CODE HERE ###
    jal ra, map
